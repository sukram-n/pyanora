...
major = {
    ...
    'Triads': {
        ...
        'chords':
            '<e g c>~<g c e>~<c e g>~<g c e>~<e g c>~F~'
...
natural_minor = {
    'One Octave': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~af~bf~c~bf~af~g~f~ef~d~c',
        'chords':
    ...
    'Two Octaves': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~af~bf~c~d~ef~f~g~af~bf~c~bf~af~g~f~ef~d~c~bf~af~g~f~ef~d~c',
        'chords':
            '<ef g c>~<g b d>~<g c ef>~<af c f>~<bf d g>~<c f af>~<d g bf>~'
            '<ef g c>~<g b d>~<g c ef>~<af c f>~<bf d g>~<c f af>~<d g bf>~'
            '<ef g c>~<d g bf>~<c f af>~<bf d g>~<af c f>~<g c ef>~<g bf d>~'
    ...
    'Triads': {
        'intro': 'r1',
        'notes':
            'c~ef~g~ef~c~F~c~ef~g~c~g~ef~c~F~c~ef~g~c~ef~c~g~ef~c~F~c~ef~g~c~ef~g~ef~c~g~ef~c~F~c~ef~g~c~ef'
            '~g~c~g~ef~c~g~ef~c',
        'chords':
            '<ef g c>~<g c ef>~<c ef g>~<g c ef>~<ef g c>~F~'
...
harmonic_minor = {
    'One Octave': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~af~b~c~b~af~g~f~ef~d~c',
        'chords':
    ...
    'Two Octaves': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~af~b~c~d~ef~f~g~af~b~c~b~af~g~f~ef~d~c~b~af~g~f~ef~d~c',
        'chords':
            '<ef g c>~<g b d>~<g c ef>~<af c f>~<b d g>~<c f af>~<d g b>~'
            '<ef g c>~<g b d>~<g c ef>~<af c f>~<b d g>~<c f af>~<d g b>~'
            '<ef g c>~<d g b>~<c f af>~<bf d g>~<af c f>~<g c ef>~<g bf d>~'
...
melodic_minor = {
    'One Octave': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~a~b~c~bf~af~g~f~ef~d~c',
        'chords':
    ...
    'Two Octaves': {
        'intro': 'r1',
        'notes':
            'c~d~ef~f~g~a~b~c~d~ef~f~g~a~b~c~bf~af~g~f~ef~d~c~bf~af~g~f~ef~d~c',
        'chords':
            '<ef g c>~<g b d>~<g c ef>~<a c f>~<b d g>~<c f a>~<d g b>~'
            '<ef g c>~<g b d>~<g c ef>~<a c f>~<b d g>~<c f a>~<d g b>~'
            '<ef g c>~<d g bf>~<c f af>~<bf d g>~<af c f>~<g c ef>~<g bf d>~'
...
def extract_data(pitch, mode, exercise) -> tuple[list[Datum], str]:
    ...
    for t in 'level fingers clefs strings'.split():
        _[t] = _clean_up(metadata[pitch][mode][exercise][t]).split()
        _[t] = (_[t] + ['-'] * l_max)[:l_max]
